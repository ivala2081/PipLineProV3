...
from app.api.v1.endpoints import transactions, analytics, users, health, translations, exchange_rates, currency_management, database, performance, bulk_rates, docs, realtime_analytics, ai_analysis, financial_performance, ai_assistant, database_management, security, trust_wallet, accounting, config, monitoring, test_standardization, metrics
...
api_v1.register_blueprint(test_standardization.test_api, url_prefix='/test')
